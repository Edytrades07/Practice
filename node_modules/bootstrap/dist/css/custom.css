  ...
  .countdown-container-mobile-timer{
    ...
    .error-message{
        ...
        @media (max-width:767px){
            ...
            h5 span{font-size:24px;font-weight:lighter;font-family:"Lato",light;}
            #cs-content.cs-content .x-btn{padding:12px 15px !important;width:100%;max-width:370px;text-shadow:none !important;}
            ...
            .x-container.cs-hide-lg.cs-hide-md.cs-hide-xl.max.width{background-image:url(https://tradersfamily.id/wp-content/uploads/2022/10/background-atas-2.png);width:100% !important;}
            div#x-section-1{background-image:none !important;}
            .hide-mobile{display:none;}
            .x-container.flex-deks.max.width{width:100% !important;background-image:url(https://tradersfamily.id/wp-content/uploads/2022/10/bg-atas-1.png);min-height:0px !important;}
            ...
            #cs-content .x-column{margin-right:4% !important;}
            .position-text-img-hd{width:360px !important;margin:15px 0 !important;}
        ...
        h3 span{font-size:24pt;}#cs-content .x-section.bg-image,#cs-content .x-section.bg-pattern{background-position:top right;}
        .x-btn-2{font-size:15px;background-color:#5ebb47;padding:13px 33px !important;color:white;border-radius:5px;border:1px solid #5ebb47;display:block;text-align:center;}
